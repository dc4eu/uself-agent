...
package com.eviden.bds.rd.uself.agent.services.repositories.rclientsession
...
@Repository
interface RClientSessionRepository : CrudRepository<RClientSession, String> {
    ...
    fun existsByCNonce(cNonce: String): Boolean
